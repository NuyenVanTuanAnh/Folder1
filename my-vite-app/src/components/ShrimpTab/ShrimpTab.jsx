...
const ShrimpTab = () => {
  ...
  const handleHistorySearch = useCallback(() => {
    ...
    callApi(
      [
        Promise.all([
          ShrimpRequestApi.ShrimpRequest.getLossShrimp(
            formData.pondId,
            formData.updateDate
          ),
          ShrimpRequestApi.ShrimpRequest.getSizeShrimp(
            formData.pondId,
            formData.updateDate
          ),
        ]),
      ...
      (res) => {
        ...
        lossData.forEach((loss) => {
          mergedData[loss.updateDate] = {
            ...mergedData[loss.updateDate],
            lossValue: loss.lossValue,
          };
        });
        sizeData.forEach((size) => {
          mergedData[size.updateDate] = {
            ...mergedData[size.updateDate],
