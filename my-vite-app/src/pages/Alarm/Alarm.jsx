...
function Alarm() {
  ...
  const fetchAlarms = useCallback(
    (page = currentPage) => {
      ...
      callApi(
        [
          AlarmRequestApi.alarmRequest.getAllAlarmByFarmId(
            farmId,
            startDate,
            endDate,
            pageSize,
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
          ...
          {alarms.length > 0 ? (
            <>
                ...
                {alarms.map((alarm, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">{alarm.alarmDetail}</p>
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <span className="text-teal-700">
                  Trang {currentPage} / {totalPages} ({startIndex} -{" "}
                  {Math.min(startIndex + pageSize - 1, totalAlarms)} /{" "}
                  {totalAlarms} mục)
                </span>
                <button
                  onClick={() => handlePageChange(currentPage + 1)}
            ...
            <p className="text-teal-700 text-center text-sm sm:text-base">
              Chưa có dữ liệu cảnh báo. Vui lòng chọn khoảng thời gian và tải dữ
              liệu.
            </p>
          )}
        </div>
