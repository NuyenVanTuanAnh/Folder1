...
import FarmRequestApi from "../../services/api/FarmApi/farmRequest";
      ...
      callApi(
        ...
        (err) => {
          ...
          if (err.response) {
            ...
            if (status === 400) {
              errorMessage =
                data.title || data.message || "Yêu cầu không hợp lệ!";
            } else if (status === 401) {
      ...
      callApi(
        ...
        (err) => {
          ...
          const errorMsg =
            ...
            "Có lỗi xảy ra khi thêm trang trại!";
        ...
        <ul className="space-y-4">
          {farms.length === 0 && !isLoading ? (
            <p className="text-gray-500 text-center">
              Chưa có trang trại nào. Vui lòng liên hệ Admin để được thêm vào
              trang trại.
            </p>
          ) : (
        ...
        <form onSubmit={handleUpdateFarm}>
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFarm({ ...editFarm, farmName: e.target.value })
              }
              placeholder="Tên trang trại"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFarm({ ...editFarm, address: e.target.value })
              }
              placeholder="Địa chỉ trang trại"
              className="w-full p-3 border border-teal-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-teal-50"
            />
